                    ...
                    <c:forEach items='${menus}' var="item">
                        <li>
	                        <a>
	                            ...
	                            <span class="nav-label">${item.menu.f_fun_name}</span>
	                            <span class="fa arrow"></span>
	                        </a>
	                        <ul class="nav nav-second-level">
	                            <c:forEach items="${item.sonMenu}" var="fun">
	                            	<c:if test="${empty fun.f_fun_url}">
	                            		<li><a class="J_menuItem" href="${pageContext.request.contextPath}/sysInit/blank">${fun.f_fun_name}</a></li>
	                            	</c:if>
	                            	<c:if test="${not empty fun.f_fun_url}">
	                            		<li><a class="J_menuItem" href="${pageContext.request.contextPath}/${fun.f_fun_url}">${fun.f_fun_name}</a></li>
	                            	</c:if>
	                            </c:forEach>
	                        </ul>
                        </li>
...
<!--             <div class="footer">
                <div class="pull-right">&copy; 2014-2015 benstar
                </div>
            </div> -->
        </div>
        <!--右侧部分结束-->
